...
| [ConvertFrom-JwtToken.ps1](./ConvertFrom-JwtToken.ps1) | Decodes a JWT (JSON Web Token) and returns its Header and Payload claims as a single object. | 1.1 | 31 Jul 2026 |
