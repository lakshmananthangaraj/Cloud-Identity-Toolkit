...
Function Get-AllUsers
{
    ...
    return $allUsers | Select-Object Id, displayName, userPrincipalName, userType, createdDateTime, accountEnabled, onPremisesSyncEnabled, lastSuccessfulSignInDateTime, lastSignInDateTime, lastNonInteractiveSignInDateTime | FT
}
